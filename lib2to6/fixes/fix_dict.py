...
d.iterkeys() -> six.iterkeys(d)
d.iteritems() -> six.iteritems(d)
d.itervalues() -> six.itervalues(d)
...
from ..fixer_util import Name, Call, LParen, RParen, ArgList, Dot, touch_import
...
class FixDict(fixer_base.BaseFix):
    ...
    def transform(self, node, results):
        ...
        if isiter:
            new.prefix = ""
            new = Call(Name("six.iter"+method_name), [new])
        if tail:
